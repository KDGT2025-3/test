	...
	<div class="container">
		...
		<div class="button-group">
			...
			<form action="reservation" method="get" style="display:inline;">
				...
				<input type="submit" value="過去の予約をクリーンアップ" class="button secondary" onclick="returnconfirm('本当に過去の予約を削除しますか？');">
			</form>
		</div>
		...
		<div class="pagination">
			...
			<c:forEach begin="1" end="${noOfPages}" var="i">
				<c:choose>
					...
					<c:otherwise>
						<ahref="reservation?action=list&page=${i}&search=${searchTerm}&sortBy=${sortBy}&sortOrder=${sortOrder}">${i}</a>
					</c:otherwise>
				</c:choose>
			</c:forEach>
